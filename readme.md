...
The second version released in April 2016 included improvements to allow reading / filtering / converting / writing RINEX files, process GLONASS data, better isolation between OSP data acquisition and RINEX generation.
The current version 2.1 released in February 2018 includes minor changes and a Linux implementation of the SerialTxRx class.
The current implementation has the following scope:
- Binaries provided are for win32 environment and for Linux.
